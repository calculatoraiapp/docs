...
<!-- gen:summary start -->
**[CalculatorAI](https://calculatorai.app)** is a personal financial workspace — not a directory of calculators. **82 calculators**, **18 trackers** and **15 document generators** live under one account in **10 languages**, and an AI copilot reads the numbers you actually put in.
<!-- gen:summary end -->
...
| | |
|---|---|
| Calculators | **82**, across **14 categories** |
| Trackers | **18** — Trading Journal, Portfolio Tracker, Dividend Tracker, Business P&L Tracker, Subscription Tracker, Invoices Tracker, Income & Expense Tracker, QR Codes, Rental Income Tracker, Budget Tracker, Debt Payoff Tracker, Savings Goals Tracker, Password Manager, Net Worth Tracker, Habit Tracker, Event Planner, Inventory Tracker, Client Booking |
| Document generators | **15** — QR Code Generator, Password Generator, Invoice Generator, Quote Template, Receipt Generator, Credit Note Template, Purchase Order Template, Proforma Invoice, Delivery Note Template, Debit Note Template, Timesheet Template, Commercial Invoice, Expense Report, Statement of Account, Progress Billing |
