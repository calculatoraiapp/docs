...
<!-- gen:summary start -->
**[CalculatorAI](https://calculatorai.app)** is a personal financial workspace — not a directory of calculators. **82 calculators**, **17 trackers** and **15 document generators** live under one account in **10 languages**, and an AI copilot reads the numbers you actually put in.
<!-- gen:summary end -->
...
| Trackers | **17** — Trading Journal, Portfolio Tracker, Dividend Tracker, Business P&L Tracker, Subscription Tracker, Invoices Tracker, Income & Expense Tracker, QR Codes, Rental Income Tracker, Budget Tracker, Debt Payoff Tracker, Savings Goals Tracker, Password Manager, Net Worth Tracker, Habit Tracker, Event Planner, Inventory Tracker |
